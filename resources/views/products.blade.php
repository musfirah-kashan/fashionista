                                ...
                                <div class="single-product-scroll">
                                    <div class="single-product-cover">
                                        <div class="single-slide zoom-image-hover">
                                            <img class="img-responsive" src="user/assets/images/product-360/1_1.jpg"
                                                alt="">
                                        </div>
                                        <div class="single-slide zoom-image-hover">
                                            <img class="img-responsive" src="user/assets/images/product-360/1_2.jpg"
                                                alt="">
                                        </div>
                                        <div class="single-slide zoom-image-hover">
                                            <img class="img-responsive" src="user/assets/images/product-360/1_3.jpg"
                                                alt="">
                                        </div>
                                        <div class="single-slide zoom-image-hover">
                                            <img class="img-responsive" src="user/assets/images/product-360/1_4.jpg"
                                                alt="">
                                        </div>
                                        <div class="single-slide zoom-image-hover">
                                            <img class="img-responsive" src="user/assets/images/product-360/1_5.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="ec-pro-variation">
                                        <div class="ec-pro-variation-inner ec-pro-variation-size">
                                            ...
                                            <div class="ec-pro-variation-content">
                                                <ul>
                                                    @foreach($size as $dd)
                                                    <li class="active"><span>{{$dd->slug}}</span></li>@endforeach
                                        ...
                                        <div class="ec-pro-variation-inner ec-pro-variation-color">
                                            ...
                                            <div class="ec-pro-variation-content">
                                                <ul>
                                                    @foreach($colors as $dd)
                                                    <li class="active"><span style="background-color:{{$dd->color}};"></span>
                                                    </li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                    ...
                                    <div class="ec-single-qty">
                                        ...
                                        <div class="ec-single-wishlist">
                                            <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                    src="user/assets/images/icons/wishlist.svg" class="svg_img pro_svg"
                                                    alt="" /></a>
                                        </div>
                                    ...
                                    <div class="ec-t-review-wrapper">
                                        <div class="ec-t-review-item">
                                            <div class="ec-t-review-avtar">
                                                <img src="user/assets/images/review-image/1.jpg" alt="" />
                                            </div>
                                        ...
                                        <div class="ec-t-review-item">
                                            <div class="ec-t-review-avtar">
                                                <img src="user/assets/images/review-image/2.jpg" alt="" />
                                            </div>
                                            <div class="ec-t-review-content">
                                                <div class="ec-t-review-top">
                    ...
                    <div class="ec-pro-image-outer">
                        <div class="ec-pro-image">
                            <a href="product-left-sidebar.html" class="image">
                                <img class="main-image" src="user/assets/images/product-image/6_1.jpg" alt="Product" />
                                <img class="hover-image" src="user/assets/images/product-image/6_2.jpg" alt="Product" />
                            </a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                        <div class="ec-pro-image">
                            <a href="product-left-sidebar.html" class="image">
                                <img class="main-image" src="user/assets/images/product-image/7_1.jpg" alt="Product" />
                                <img class="hover-image" src="user/assets/images/product-image/7_2.jpg" alt="Product" />
                            </a>
                            <span class="percentage">20%</span>
                            <span class="flags">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                        <div class="ec-pro-image">
                            <a href="product-left-sidebar.html" class="image">
                                <img class="main-image" src="user/assets/images/product-image/1_1.jpg" alt="Product" />
                                <img class="hover-image" src="user/assets/images/product-image/1_2.jpg" alt="Product" />
                            </a>
                            <span class="percentage">20%</span>
                            <span class="flags">
                                <span class="sale">Sale</span>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                        <div class="ec-pro-image">
                            <a href="product-left-sidebar.html" class="image">
                                <img class="main-image" src="user/assets/images/product-image/2_1.jpg" alt="Product" />
                                <img class="hover-image" src="user/assets/images/product-image/2_2.jpg" alt="Product" />
                            </a>
                            <span class="percentage">20%</span>
                            <span class="flags">
