...
<head>
	...
	<title>FashionIsta - User Dashboard</title>
	<!-- GOOGLE FONTS -->
			...
			<div id="sidebar" class="sidebar ec-sidebar-footer">
				...
				<div class="ec-navigation" data-simplebar>
					...
					<ul class="nav sidebar-inner" id="sidebar-menu">
						<!-- Dashboard -->
						<li class="active">
							<a class="sidenav-item-link" href="userdashboard">
						...
						<!-- orders -->
						<li class="has-sub">
							<a class="sidenav-item-link" href="myorders">
								<i class="mdi mdi-dns-outline"></i>
								<span class="nav-text">My Orders</span> <b class="caret"></b>
							</a>
						</li>

						<li class="has-sub">
							<a class="sidenav-item-link" href="ordertrack">
								<i class="mdi mdi-dns-outline"></i>
								<span class="nav-text">Order Tracking</span> <b class="caret"></b>
							</a>
						</li>
						<!-- Brands -->
						<!-- <li>
