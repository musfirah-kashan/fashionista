          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                <!-- Text based logo -->
                <a href="{{url('/')}}">
                 <img src="/front_assets/img/logo.png" width="175px" height="75px" />
                </a>
                <!-- img based logo -->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>Contact Us</h3>
                    <address>
                      <p> Saddar Karachi, Sindh,PAK</p>
                      <p><span class="fa fa-phone"></span>+300-2222221</p>
                      <p><span class="fa fa-envelope"></span>info@fashionista.ml</p>
                    </address>
